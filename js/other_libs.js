...
$(window).load(function(){
    ...
    var nice=$('html').niceScroll({cursorborder:"",cursorcolor:"rgba(0,0,0,0.2)",cursorwidth:"5px"});
});
$(".tkt-lists").niceScroll({cursorcolor:"rgba(0,0,0,0.2)",cursoropacitymax:0.7,boxzoom:false,touchbehavior:true,autohidemode: false,cursorwidth:"5px"}); 
